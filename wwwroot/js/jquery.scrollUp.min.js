...
!function(a,b,c){
    ...
    a.fn.scrollUp.init=function(d){
        ...
        e.appendTo("body");
        f.scrollImg||f.scrollTrigger||e.html(f.scrollText); // Hiển thị mũi tên
        ...
        var g,h,i,j;
        switch(f.animation){
            case"fade": g="fadeIn"; h="fadeOut"; i=f.animationSpeed; break;
            case"slide": g="slideDown"; h="slideUp"; i=f.animationSpeed; break;
            default: g="show"; h="hide"; i=0;
        }
        ...
        e.click(function(b){
            b.preventDefault();
            a("html, body").animate({scrollTop:l},f.scrollSpeed,f.easingType)
        })
    },
